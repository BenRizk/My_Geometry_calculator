...
namespace WinformTest1
{
    public partial class Calculator : Form
    {
        ...
        int[,] lines = new int[10, 2]; // double array to hold lines in y = mx + b
        ...
        private void button1_Click_1(object sender, EventArgs e) //button to determine angle
        {
            ...
            {
                hold1 = dataPoints[Int32.Parse(textBox4.Text)-1]; //find first angle
                ...
                hold3 = dataPoints[Int32.Parse(textBox5.Text)-1]; //find second angle
            ...
            label10.Text = "Results: " + (angle1-angle2).ToString(); //output total angle
        }
